document.addEventListener('DOMContentLoaded', function () {
    // Load FullCalendar library dynamically to ensure it's available when needed
    loadScript('https://cdnjs.cloudflare.com/ajax/libs/fullcalendar/5.11.3/main.min.js', function () {
        loadScript('https://cdnjs.cloudflare.com/ajax/libs/fullcalendar/5.11.3/locales-all.min.js', function () {
            initializeApp();
        });
    });
